premLeague_17_18 <- read.csv("Premier_League_17-18.csv")
premLeague_17_18_table <- read.csv("Premier_League_table-17-18.csv")
columnSums <- function(teamName){
  
  dataset<- premLeague_17_18 %>%
...
my_matrix
premLeague_17_18_clean <- as.data.frame(my_matrix)
LeaguePosition <- c(1,4,5,3,6,2,8,9,13,14,11,12,7,17)
premLeague_17_18_clean$Position <- LeaguePosition
premLeague_17_18_clean <-premLeague_17_18_clean[,c(9,1,2,3,4,5,6,7,8)]
write.csv(premLeague_17_18_clean, "premLeague_17_18_clean.csv")
