# working with 2018-2019 dataset
library(dplyr)
library(xml2)
library(rvest)
library(tidyverse)

premLeague_18_19 <- read.csv("Premier_League_18-19.csv")

#Data transformation

columnSums <- function(teamName){
  
  dataset<- premLeague_18_19 %>%
...
premLeague_18_19_clean <- as.data.frame(my_matrix)
LeaguePosition <- c(1,2,3,4,5,6,8,9,10,11,12,14,15,16)
premLeague_18_19_clean$Position <- LeaguePosition
premLeague_18_19_clean <-premLeague_18_19_clean[,c(9,1,2,3,4,5,6,7,8)]
write.csv(premLeague_18_19_clean, "premLeague_18_19_clean.csv")
